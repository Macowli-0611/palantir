  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row items-center gap-12 p-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full glassmorphism border-cyan-palantir/30 text-xs text-cyan-palantir uppercase tracking-widest font-mono mb-6 w-max">
          <span className="w-2 h-2 rounded-full bg-cyan-palantir animate-pulse"></span>
          Política de Derechos Humanos
        </motion.div>

        <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-extrabold tracking-tighter cyber-gradient leading-tight mb-6">
          Defendiendo los Derechos Humanos en la Era de los Datos y la IA
        </motion.h1>

        <motion.p variants={itemVariants} className="text-lg text-text-muted font-light leading-relaxed mb-10">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
          <div className="glassmorphism rounded-xl p-4 glow-hover">
            <span className="font-mono text-xs text-text-mono uppercase block mb-1">Legado</span>
            <strong className="text-xl text-white block">20+ Años</strong>
            <span className="text-xs text-text-muted">Defendiendo derechos desde 2003</span>
          </div>
          <div className="glassmorphism rounded-xl p-4 glow-hover">
            <span className="font-mono text-xs text-text-mono uppercase block mb-1">Modelo</span>
            <strong className="text-xl text-white block">Zero Brokerage</strong>
            <span className="text-xs text-text-muted">Software, no venta de datos</span>
          </div>
        </motion.div>
      </motion.div>
