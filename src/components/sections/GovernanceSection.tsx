...
const GOVERNANCE = [
  {
    ...
    color: "cyan-palantir",
    image: "/assets/media_1787780523118.png"
  },
  {
    id: "pcap",
    icon: Users,
    ...
    color: "emerald-grid",
    image: "/assets/media_1787780942980.png"
  },
  {
    id: "ngo",
    icon: Globe2,
    ...
    color: "amber-warning",
    image: "/assets/media_1787783955470.png"
  }
];
        ...
        {GOVERNANCE.map((item) => (
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-40 z-0">
               <div className="absolute inset-0 bg-cyan-palantir/20 mix-blend-overlay z-10 group-hover:bg-cyan-palantir/0 transition-colors duration-500"></div>
               <img src={item.image} alt="" className="w-full h-full object-cover object-top opacity-40 group-hover:opacity-70 group-hover:scale-105 transition-all duration-700" />
               <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-void/60 to-slate-void/90 h-40 z-20"></div>
            </div>
            ...
            <div className="relative z-20 mt-12 w-12 h-12 rounded-xl border border-white/10 bg-obsidian/80 backdrop-blur-md flex items-center justify-center mb-6 group-hover:border-cyan-palantir/50 group-hover:bg-cyan-palantir/20 transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)]">
